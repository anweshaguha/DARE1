...
rc_b6 <- rc_b2 <- feols(ODR_objective ~ eval + FRPL_percent + enroll_OTHER + enroll_AM + enroll_AM + enroll_HISP + enroll_ASIAN + enroll_BLACK + enroll_WHITE + run_time|
                        state_id + school_year,
                      data = dare1_clean,
                      weights = dare1_clean$enroll)
summary(rc_b6)

compare_performance(rc_b11, rc_b12,rc_b13, rc_b11s, rc_b12s, rc_b13s, rc_b1, rc_b2, rc_b3, rc_b4, rc_b5, rc_b6, rank = TRUE) %>%
  print_md()
```
